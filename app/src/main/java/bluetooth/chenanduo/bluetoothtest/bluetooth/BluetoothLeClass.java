...
package bluetooth.chenanduo.bluetoothtest.bluetooth;
...
public class BluetoothLeClass {
    ...
    public void displayGattServices(List<BluetoothGattService> gattServices, String SERVICE_UUID, String NOTIFICATION_UUID) {
